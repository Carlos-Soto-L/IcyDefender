...
public class scriptTallerJacobo : MonoBehaviour
{
    // Referencia al panel 
    ...
    void Update()
    {
        ...
        if (isVisiblePantalla == false)
        {
            ...
            mostrarPantalla("2 semanas después...");
    ...
    private void siguienteLineaDialogo()
    {
        ...
        if (iLineIndex < arrDialogos.Length)
        {
            ...
            if (iLineIndex == 10)
            {
                ...
                mostrarPantalla("Jacobo se retira abatido.");
        ...
        else
        {
            ...
            SceneManager.LoadScene("cinPresentacionNieves");
        }
    }
