...
public class scriptPresentacionNieve : MonoBehaviour
{
    // Referencia al panel 
    ...
    // Referencia al peronaje (en este caso a Jacobo)
    [SerializeField] private GameObject comite_normal;
    ...
    void Update()
    {
        ...
        if (isVisiblePantalla == false)
        {
            ...
            mostrarPantalla("Al día siguiente, Marco llega al evento público con la nieve.");
    ...
    private void siguienteLineaDialogo()
    {
        ...
        if (iLineIndex < arrDialogos.Length)
        {
            ...
            if (iLineIndex == 12)
            {
                ...
                mostrarPantalla("Minutos después");
                comite_normal.SetActive(false);
        ...
        else
        {
            ...
            SceneManager.LoadScene("cinHabitacionJacobo");
        }
    }
